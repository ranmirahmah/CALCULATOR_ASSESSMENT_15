  ...
  return (
    <div className=' w-screen  h-[100%] flex flex-row justify-around align-middle items-center'>
        ...
        <div className=' w-full flex flex-row gap-10 pt-6'>
            <button className='w-28 h-6 bg-[#ee8a19] font-medium  text[10px]  text-white'>
                Get Started
            </button>
            <button className='w-28 h-6 bg-transparent  border border-gray-50 border-2 font-medium  text-[10px]  text-white'>
                Free Trial
                </button>
        </div>
        </div>
